...
>
  <DotsIcon />
          ...
          <div className="flex items-center gap-4">
            <div className="h-14 w-14 rounded-full bg-white/15 ring-2 ring-white/10 flex items-center justify-center">
              ...
              <svg width="28" height="28" viewBox="0 0 24 24" className="opacity-90">
                <path fill="currentColor" d="M12 12a5 5 0 1 0-5-5a5 5 0 0 0 5 5m0 2c-5 0-9 2.5-9 5.5V22h18v-2.5c0-3-4-5.5-9-5.5"/>
              </svg>
            </div>
            {open && (
              <div>
        ...
        <nav className="mt-2">
          ...
          {/* Ejemplos de extra (si luego agregas) */}
          {/* <SideItem to="/admin/stats" icon={BarsIcon} label="Estadísticas" open={open} /> */}
          {/* <SideItem to="/admin/options" icon={GearIcon} label="Opciones" open={open} /> */}
        </nav>
      </aside>
...
function GearIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" className="opacity-95">
      <path fill="currentColor" d="m12 8a4 4 0 1 1 0 8a4 4 0 0 1 0-8m9 4l-2.1 1.6l.3 2.6l-2.5.9l-1.4 2.2l-2.6-.7L12 22l-1.6-2.1l-2.6.7l-1.4-2.2l-2.5-.9l.3-2.6L2 12l2.1-1.6l-.3-2.6l2.5-.9l1.4-2.2l2.6.7L12 2l1.6 2.1l2.6-.7l1.4 2.2l2.5.9l-.3 2.6z"/>
    </svg>
  );
}
function DotsIcon() {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" className="text-slate-200">
      <path fill="currentColor" d="M12 6.5a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m0 8a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m0 8a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3"/>
    </svg>
  );
}
